...
- Create: `Sources/Notty/NottyApp.swift`
- Create: `Sources/Notty/Info.plist`
...
```swift
// Sources/Notty/AppDelegate.swift
import AppKit
...
class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    func applicationDidFinishLaunching(_ notification: Notification) {
        ...
        statusItem?.button?.image = NSImage(systemSymbolName: "note.text", accessibilityDescription: "Notty")
        ...
        menu.addItem(NSMenuItem.separator())
        menu.addItem(NSMenuItem(title: "Quit Notty", action: #selector(quit), keyEquivalent: "q"))
...
**Files:**
- Create: `Sources/Notty/UI/FloatingPanel.swift`
- Create: `Sources/Notty/UI/OverlayView.swift`
- Modify: `Sources/Notty/AppDelegate.swift`

**Step 1: Create NSPanel subclass with vibrancy**

```swift
// Sources/Notty/UI/FloatingPanel.swift
import AppKit
...
```swift
// Sources/Notty/UI/OverlayView.swift
import SwiftUI
...
**Files:**
- Modify: `Sources/Notty/AppDelegate.swift`
- Create: `Sources/Notty/HotkeyManager.swift`

**Step 1: Define hotkey name**

```swift
// Sources/Notty/HotkeyManager.swift
...
**Files:**
- Create: `Sources/Notty/Extensions/ExtensionProtocol.swift`

**Step 1: Define protocol and result types**

```swift
// Sources/Notty/Extensions/ExtensionProtocol.swift
import Foundation
...
```
feat: define NottyExtension protocol
```
...
**Files:**
- Create: `Sources/Notty/Notes/NoteExtractor.swift`
- Create: `Sources/Notty/Notes/NoteRecord.swift`

**Step 1: Define NoteRecord model**

```swift
// Sources/Notty/Notes/NoteRecord.swift
import Foundation
...
```swift
// Sources/Notty/Notes/NoteExtractor.swift
import AppKit
...
**Files:**
- Create: `Sources/Notty/Store/VectorStore.swift`
- Create: `Sources/Notty/Store/TextChunker.swift`

**Step 1: Implement TextChunker**

```swift
// Sources/Notty/Store/TextChunker.swift
import Foundation
...
```swift
// Sources/Notty/Store/VectorStore.swift
import Foundation
import SQLite3
import Accelerate
...
final class VectorStore {
    ...
    init() throws {
        ...
        let nottyDir = appSupport.appendingPathComponent("Notty")
        try FileManager.default.createDirectory(at: nottyDir, withIntermediateDirectories: true)
        let dbPath = nottyDir.appendingPathComponent("notty.db").path
...
**Files:**
- Create: `Sources/Notty/MLX/MLXService.swift`
- Create: `Sources/Notty/MLX/ModelDiscovery.swift`

**Step 1: Implement ModelDiscovery**

```swift
// Sources/Notty/MLX/ModelDiscovery.swift
import Foundation
...
```swift
// Sources/Notty/MLX/MLXService.swift
import Foundation
import MLX
import MLXLLM
import MLXLMCommon
...
**Files:**
- Create: `Sources/Notty/Engine/QueryEngine.swift`
- Create: `Sources/Notty/Engine/Indexer.swift`

**Step 1: Implement Indexer**

```swift
// Sources/Notty/Engine/Indexer.swift
import Foundation
...
```swift
// Sources/Notty/Engine/QueryEngine.swift
import Foundation
...
**Files:**
- Create: `Sources/Notty/Extensions/NotesExtension.swift`

**Step 1: Implement NotesExtension conforming to protocol**

```swift
// Sources/Notty/Extensions/NotesExtension.swift
import Foundation
...
**Files:**
- Create: `Sources/Notty/UI/SettingsView.swift`
- Modify: `Sources/Notty/NottyApp.swift`

**Step 1: Implement SettingsView**

```swift
// Sources/Notty/UI/SettingsView.swift
import SwiftUI
import KeyboardShortcuts
...
**Step 2: Wire into NottyApp scene**
